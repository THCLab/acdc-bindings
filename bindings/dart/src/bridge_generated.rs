...
fn wire_issue_public_untargeted__static_method__ACDC_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, ACDC, _>(
        WrapInfo {
...
fn wire_get_issuer__method__ACDC_impl(port_: MessagePort, that: impl Wire2Api<ACDC> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, String, _>(
        ...
        move || {
            let api_that = that.wire2api();
            move |task_callback| Result::<_, ()>::Ok(ACDC::get_issuer(&api_that))
        },
    )
}
...
fn wire_get_schema__method__ACDC_impl(port_: MessagePort, that: impl Wire2Api<ACDC> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, String, _>(
        ...
        move || {
            let api_that = that.wire2api();
            move |task_callback| Result::<_, ()>::Ok(ACDC::get_schema(&api_that))
        },
    )
}
fn wire_get_digest__method__ACDC_impl(port_: MessagePort, that: impl Wire2Api<ACDC> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, String, _>(
        WrapInfo {
            debug_name: "get_digest__method__ACDC",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            let api_that = that.wire2api();
            move |task_callback| Result::<_, ()>::Ok(ACDC::get_digest(&api_that))
        },
    )
}
fn wire_parse__static_method__ACDC_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, ACDC, _>(
        ...
        move || {
            ...
            move |task_callback| ACDC::parse(api_stream)
        },
    )
}
...
impl rust2dart::IntoIntoDart<ACDC> for ACDC {
